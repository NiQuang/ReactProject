...
export default function LayoutWebsite() {
  const headerlogo = 'http://blog.logomyway.com/wp-content/uploads/2020/08/vans-red-logo.jpg';
  ...
  <div>
        <header className="header">
            <div className="grid wide">
                <nav className="header__navbar hide-on-mobile-tablet">
                    <ul className="header__navbar-list">
                        <li className="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
                            ...
                            <div className="header__qr">
                                <img src="./assets/img/qrcode.png" alt="QR code" className="headr__qr-img" />
                                <div className="header__qr-apps">
                                    <a href="" className="header__qr-link">
                                        <img src="./assets/img/chplay.png" className="header__qr-download-img /"
                                            alt="Google Play" />
                                    </a>
                                    <a href="" className="header__qr-link">
                                        <img src="./assets/img/appstore.png" className="header__qr-download-img /"
                                            alt="App Store" />
                                    </a>
                                </div>
                            </div>
                    ...
                    <ul className="header__navbar-list">
                        <li className="header__navbar-item header__navbar-item--has-notify">
                            <a href="" className="header__navbar-item-link">
                                <i className="header__navbar-icon far fa-bell"></i>Thông báo
                            </a>
                            <div className="header__notification">
                                <header className="header__notification-header">
                                ...
                                <ul className="header__notification-list">
                                    <li className="header__notification-item">
                                        <a href="" className="header__notification-link">
                                            <img src="./assets/img/qrcode.png" alt="" className="header__notification-img" />
                                    ...
                                    <li className="header__notification-item">
                                        <a href="" className="header__notification-link header__notification-item--viewed">
                                            <img src="./assets/img/chplay.png" alt="" className="header__notification-img" />
                                            <div className="header__notification-info">
                                                <span className="header__notification-name">
                                                    Trường hợp 1: Phụ huynh/Người bảo trợ hoặc sinh viên (tự lo chi phí
                                                    học tập) bị cơ quan cắt giảm lương, nghỉ việc tạm thời hoặc giảm giờ
                                                    làm do cơ quan có ít đơn hàng hoặc thực hiện cắt giảm chi phí do ảnh
                                                    hưởng Covid 19
                                ...
                                <footer className="header__notification-footer">
                                    <a href="" className="header__notification-footer-btn">Xem tất cả</a>
                                </footer>
                            </div>
                        </li>
                        ...
                        <li className="header__navbar-item">
                            <a href="" className="header__navbar-item-link">
                                <i className="header__navbar-icon far fa-question-circle"></i>Trợ giúp</a>
                        </li>
                    ...
                    <li className="header__navbar-item header__navbar-item--bold">
                        ...
                        <li className="header__navbar-item header__navbar--user">
                            <img src="./assets/img/q-logo.jpg" alt="" className="header__navbar--user-img" />
                            <span className="header__navbar--user-name">Ni.Quang</span>
                ...
                <div className="header-with-search">
                    {/* <!-- Header icon bar on mobile --> */}
                    <div className="header__icon-bar">
                        <label>
                        {/* <label for="mobile__icon-bar"> */}
                            <i className="fas fa-list mobile__icon-bar-icon"></i>
                        </label>
                        <input type="checkbox" id="mobile__icon-bar" className="mobile__icon-bar" hidden />
                        {/* <!-- nav on mobile --> */}
                        <label className="nav__mobile-overlay">
                        {/* <label for="mobile__icon-bar" className="nav__mobile-overlay"> */}
                        </label>
                        <ul className="nav__mobile-list">
                            <label>
                            {/* <label for="mobile__icon-bar"> */}
                              <i className="fas fa-times nav__mobile-times"></i>
                              </label>

                            <li className="nav__mobile-item">
                                <a href="#" className="nav__mobile-link">1</a>
                            </li>
                            <li className="nav__mobile-item">
                                <a href="#" className="nav__mobile-link">2</a>
                            </li>
                            <li className="nav__mobile-item">
                                <a href="#" className="nav__mobile-link">3</a>
                            </li>
                            <li className="nav__mobile-item">
                                <a href="#" className="nav__mobile-link">4</a>
                            </li>
                        </ul>
                    </div>
                    {/* <!-- header mobile search --> */}
                    <label className="header__moblie-search">
                    {/* <label for="moblie-search-checkbox" className="header__moblie-search"> */}
                        <i className="header__moblie-search-icon fas fa-search"></i>
                    </label>
                    ...
                    <input type="checkbox" id="moblie-search-checkbox" className="moblie-search-checkbox" hidden />
                    ...
                    <div className="header__cart">
                        <div className="header__cart-wrap">
                            ...
                            <div className="header__cart-info">
                                <img src="./assets/img/no-found.jpg" alt="" className="header__cart-no-cart-img" />
                                <p className="header__cart-no-cart-msg">Chưa có sản phẩm</p>

                                <h4 className="header__cart-info-heading">
                                    Sản phẩm đã thêm
                                </h4>
                                <ul className="header__cart-list">
                                    {/* <!-- cart item --> */}
                                    <li className="header__cart-list-item">
                                        <img src="./assets/img/no-found.jpg" alt="" className="header__cart-list-img" />
                                        <div className="header__cart-item-detail">
                                            <div className="header__cart-item-head">
                                                <h5 className="header__cart-iteam-name">
                                                    Kem đặc trị vùng mắt thử chỉnh xem cái tên dài ơi là dài xem nó lỗi
                                                    thế nào xem nào
                                                </h5>
                                                <div className="header__cart-item-price-wrap">
                                                    ...
                                                    <span className="header__cart-item-multi">
                                                        x
                                                    </span>
                                                    <span className="header__cart-item-quantily">
                                                        2
                                                    </span>
                                                </div>
    ...
    <div className="grid wide footer__content">
        <div className="row">
            ...
            <div className="col l-2-4 m-4 c-6">
                <h3 className="footer__heading">Về NiQ</h3>
                <ul className="footer__list">
                    <li className="footer-item">
                        <a href="" className="footer-item__link">Giới thiệu về NiQ</a>
                    </li>
                    <li className="footer-item">
                        <a href="" className="footer-item__link">Tuyển dụng</a>
                    </li>
                    <li className="footer-item">
                        <a href="" className="footer-item__link">Điều khoản về NiQ</a>
                    </li>
                </ul>
            </div>
            <div className="col l-2-4 m-4 c-6">
            ...
            <div className="col l-2-4 m-4 c-12">
                <h3 className="footer__heading">Vào cửa hàng trên ứng dụng NiQ</h3>
                <div className="footer__download">
                    <img src="./assets/img/qrcode.png" alt="Download QR" className="footer__download-qr" />
